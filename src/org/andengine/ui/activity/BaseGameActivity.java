...
public abstract class BaseGameActivity extends BaseActivity implements IGameInterface, IRendererListener {
	...
	protected void onCreate(final Bundle pSavedInstanceState) {
		if(BuildConfig.DEBUG) {
			Debug.d(".onCreate" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public synchronized void onSurfaceCreated(final GLState pGLState) {
		if(BuildConfig.DEBUG) {
			Debug.d(".onSurfaceCreated" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public synchronized void onSurfaceChanged(final GLState pGLState, final int pWidth, final int pHeight) {
		if(BuildConfig.DEBUG) {
			Debug.d(".onSurfaceChanged(Width=" + pWidth + ",  Height=" + pHeight + ")" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	}

	protected synchronized void onCreateGame() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onCreateGame" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
		...
		final OnPopulateSceneCallback onPopulateSceneCallback = new OnPopulateSceneCallback() {
			...
			public void onPopulateSceneFinished() {
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(".onGameCreated" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onGameCreated();
				} catch(final Throwable pThrowable) {
					Debug.e(".onGameCreated failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
		...
		final OnCreateSceneCallback onCreateSceneCallback = new OnCreateSceneCallback() {
			...
			public void onCreateSceneFinished(final Scene pScene) {
				...
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(".onPopulateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onPopulateScene(pScene, onPopulateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(".onPopulateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
		...
		final OnCreateResourcesCallback onCreateResourcesCallback = new OnCreateResourcesCallback() {
			...
			public void onCreateResourcesFinished() {
				try {
					if(BuildConfig.DEBUG) {
						Debug.d(".onCreateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					BaseGameActivity.this.onCreateScene(onCreateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(".onCreateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
		...
		try {
			if(BuildConfig.DEBUG) {
				Debug.d(".onCreateResources" + " @(Thread: '" + Thread.currentThread().getName() + "')");
			}

			this.onCreateResources(onCreateResourcesCallback);
		} catch(final Throwable pThrowable) {
			Debug.e(".onCreateGame failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
		}
	}
	...
	public synchronized void onGameCreated() {
		...
		if(this.mOnReloadResourcesScheduled) {
			...
			try {
				...
				Debug.e(".onReloadResources failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
			}
		}
	}
	...
	protected synchronized void onResume() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onResume" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public synchronized void onResumeGame() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onResumeGame" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public void onReloadResources() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onReloadResources" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	protected void onPause() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onPause" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public synchronized void onPauseGame() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onPauseGame" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	protected void onDestroy() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onDestroy" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
		...
		try {
			...
			Debug.e(".onDestroyResources failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
		}
	...
	public void onDestroyResources() throws Exception {
		if(BuildConfig.DEBUG) {
			Debug.d(".onDestroyResources" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
	...
	public synchronized void onGameDestroyed() {
		if(BuildConfig.DEBUG) {
			Debug.d(".onGameDestroyed" + " @(Thread: '" + Thread.currentThread().getName() + "')");
		}
