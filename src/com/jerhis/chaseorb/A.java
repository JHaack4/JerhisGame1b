...
public class A {
	...
	public static void load() {
        ...
        charCodes.add("Cb"); tilesList.add(chaser);
        charCodes.add("Ob"); tilesList.add(orb);
        charCodes.add("Cc"); tilesList.add(chaser);
        charCodes.add("Oc"); tilesList.add(orb);
        charCodes.add("Cd"); tilesList.add(chaser);
        charCodes.add("Od"); tilesList.add(orb);
        charCodes.add("Ce"); tilesList.add(chaser);
        charCodes.add("Oe"); tilesList.add(orb);
        charCodes.add("Cf"); tilesList.add(chaser);
        charCodes.add("Of"); tilesList.add(orb);
